  ...
  return (
    ...
    >
      ...
      <div className="my-[0.4375rem] flex flex-1 flex-col justify-center gap-4 text-center text-normal md:mx-[2.18rem] md:my-[1.56rem] md:text-left lg:my-[6.57rem]">
        ...
        <p className="max-w-[43ch] leading-[1.6] tracking-[0.01em] text-medium-grey md:text-normal lg:mt-[2rem] max-md:mx-auto">
        ...
        <a
          href="/"
          className="my-[2rem] block w-max rounded-2xl border-2 border-almost-black bg-almost-black p-3 px-[1.9rem] py-[1rem] font-[700] text-white hover:bg-transparent hover:text-almost-black max-md:mx-auto"
        >
          Learn more
        </a>
        <div className="md:mt-[3.67rem]">
          <h2 className="sr-only">Customers</h2>
          <ul className="flex flex-wrap items-center gap-3 max-md:justify-center">
            <li>
